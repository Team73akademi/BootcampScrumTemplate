...
public class KarakterKontrol : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider target)
    {
        ...
        else if (cubes.Count > 0 && target.gameObject.tag=="DizB"||target.gameObject.tag!="Diz"+transform.GetChild(0).GetChild(0).GetChild(1).GetComponent<SkinnedMeshRenderer>().material.name.Substring(0, 1)&& target.gameObject.tag.StartsWith("diz"))
        {
